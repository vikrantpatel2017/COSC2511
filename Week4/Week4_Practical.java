...
public class Week4_Practical {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hey user! enter the lower limit: ");
        int lowerLimit = myScanner.nextInt();

        System.out.println("Hey user! enter the upper limit: ");
        int upperLimit = myScanner.nextInt();

        System.out.println("You have entred lower limit as: " + lowerLimit);

        System.out.println("You have entred upper limit as: " + upperLimit);

        System.out.println(
                "Hey user, enter a value to check whether this value is in between lower limit and upper limit or not: ");
        int enteredValue = myScanner.nextInt();

        if (enteredValue >= lowerLimit && enteredValue <= upperLimit) {
            System.out.println("Well done! "+enteredValue+" is in range: ("+ lowerLimit +" , "+ upperLimit +").");
        } else {
              System.out.println("OHH NOOOO! "+enteredValue+" is NOT IN range: ("+ lowerLimit +" , "+ upperLimit +").");
        }
